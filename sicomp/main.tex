...
$O(\frac{n}{\log n})$.
\item Determine the asymptotic complexity of the linear operator in terms of the
number of zeroes in the non-commutative case.
\end{enumerate}


\section*{Acknowledgments}
We thank Paweł Gawrychowski for pointing us out to the
