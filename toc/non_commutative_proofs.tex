...
\todo[inline]{Reviewer~1: ``At first, I wasn’t sure what this paragraph is trying to say. Later, I realized that this paragraph is trying to justify that non-increasing or non-range circuits can make sense. Make it more explicit.''~--- Thank you, we added clarification.}
