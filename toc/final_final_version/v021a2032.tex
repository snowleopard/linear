...
\expref{Theorem}{thm:upperboundold} and \expref{Corollary}{cor:matrixmultiplication} give
...
\expref{Theorem}{thm:upperboundold} and \expref{Corollary}{cor:matrixmultiplication}
...
As we discuss in \expref{Section}{sec-dense-graph}, \expref{Theorem}{thm:upperboundold}
...
\node[v] (c) at (14,0) {(non-commutative) dense linear operator problem over $X$ has $O(s)$ size circuits};
