...
for 
the %% AU edit4 (AK)
complements of sparse % graphs.  %% ToC edit1 -->
digraphs.  %% <--
...
%% AU edit4 (AK) added:
His \phd advisor is~Edward~A. Hirsch.
Currently, Alexander is a~researcher at~JetBrains Research
and the Head of~Computer Science and Artificial Intelligence B.Sc. program 
...
He~co-authored three books and sixteen massive open online courses on~algorithms and discrete mathematics with over a~million enrolled students.
In~his spare time, he~enjoys discussing circuit complexity of the $\operatorname{MOD}_3$ function with Alexander Golovnev.
\end{tocabout}
