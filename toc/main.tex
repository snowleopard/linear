...
\newcommand{\stodo}[1]{\todo[inline, color=red!20]{[Sasha] #1}}
\newcommand{\atodo}[1]{\todo[inline, color=red!20]{[Andrey] #1}}
...
\atodo{Sasha: Should we just state everywhere that we assume that the matrix does not contain empty rows and delete the footnote?}
