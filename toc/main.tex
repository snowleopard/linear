...
definition~(\ref{eq-multiplication}), takes $O(u)$ semigroup operations.
The main question we~study is: can $Ax$~be computed using $O(z)$ semigroup
operations?
...
$O(n)$ ones. Our solution for the above example involving $S=(\{0,1\}, \oplus)$
