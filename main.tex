...
and $u$~ones and $x \in S^n$\todo{V: I really do not like that our formal variables are elements of the semigroup. This is mathematically incorrect.} be an~$n$-dimensional vector of
