...
optimal as shown by Chazelle and Rosenberg.
...
\todo[inline]{Andrey, ya do sih por ne ponimayu, gde zdes' nugna kommutativnost'...}
...
\todo[inline]{Andrey, a ti ne hochesch' upomyanut' zdes' kompaktnie predstavleniya graphov v funktsional'nikh yazikakh?}
...
(its identities are just graphic{\todo{chto eto?..}} equalities). It is also easy to see that the
