...
inverse Ackermann function (the optimality of this construction was shown by
...
commutative. Note that the existence of inverses does not help, i.e. the case of
non-commutative groups is strictly harder than the case of commutative
semigroups, which may be counterintuitive.
